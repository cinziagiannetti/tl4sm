...
setup(
  ...
  url = 'https://github.com/nakessien/BM_TL_classification',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/nakessien/tl4sm/archive/0.1.tar.gz',    # I explain this later on
